...
async def start_interview(candidate_id: str, service: InterviewService = Depends(InterviewService.get_instance)):
...
async def update_transcript(
    ...
    service: InterviewService = Depends(InterviewService.get_instance)
):
