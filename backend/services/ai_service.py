...
class AIService:
    ...
    async def analyze_candidate_application(self, candidate_data: Dict[str, Any], resume_text: Optional[str] = None) -> Dict[str, Any]:
        """Analyze a candidate application using Gemini AI"""
        if not self.model:
